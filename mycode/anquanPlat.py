...
def loginPlat(session, student, headers):
    ...
    if logres['err_desc'] != "":
        ...
        gheader = {
            ...
            'Cookie':'dwz_theme=azure; qimo_seosource_0=%E7%AB%99%E5%86%85; qimo_seokeywords_0=; uuid_dd39b150-a934-11e9-b073-e9b8d9c630e7=0f269387-436c-4644-8189-a7b1bfc4c978; qimo_seosource_dd39b150-a934-11e9-b073-e9b8d9c630e7=%E7%AB%99%E5%86%85; qimo_seokeywords_dd39b150-a934-11e9-b073-e9b8d9c630e7=; qimo_xstKeywords_dd39b150-a934-11e9-b073-e9b8d9c630e7=; href=https%3A%2F%2Fjiangmen.xueanquan.com%2Flogin.html; accessId=dd39b150-a934-11e9-b073-e9b8d9c630e7; ASP.NET_SessionId=tl3bhcc41o0hxq4dtm3cbjju; UserID=6C811E0E8AF1C013FE3F6A841B4F084A; ServerSide=https://jiangmen.xueanquan.com; _UCodeStr={%0d%0a  "Grade": 5,%0d%0a  "ClassRoom": 533908960,%0d%0a  "CityCode": 120017%0d%0a}; _UserID=KPKy5xA86SEC2dnmlaX6oYh709sj4EGdLzyv5HPMnfk=; SafeApp=true; RiskApp=true; PeiXun_UserID=26BF96B8787BF0E02EC3609F8067252D; Training=true; pageViewNum=3'
        }
                    ...
                    for couse in homeworklistres:
                        if couse['workStatus'] == 'UnFinish':
                            ...
                            if couse['subTitle'] == '专题活动':
                                ...
                                step1data = {"specialId": 826, "step": 1}
                                session.post(huodongSignUrl, json=step1data).json()
                                step2data = {"specialId": 826, "step": 2}
                                session.post(huodongSignUrl, json=step2data).json()
                                huodongres = session.get(
                                    'https://huodongapi.xueanquan.com/p/guangdong/Topic/topic/platformapi/api/v1/records/finish-status?specialId=826').json()
